...
intro_image_urls = {
    ...
    "https://iili.io/K8rIbJR.png",
    "https://iili.io/K8DLt5X.jpg",
    "https://iili.io/KSnOyI2.jpg",
...
DivisionTypes = {
    ...
    ["11th Kasrkin Wardens"] = {
        ...
        Ranks = {
	    	...
	    	{ID = 4, Name = "Inquisitorial Senior Operative", Rank_Prefix = "ISO", ModelsAllowed = KARSKIN_OFFICER, WeaponsAllowed = KARSIKIN_WEAPONS, CanPromote = false},
			{ID = 5, Name = "Inquisitorial Tactician Operative", Rank_Prefix = "ITO", ModelsAllowed = KARSKIN_OFFICER, WeaponsAllowed = KARSIKIN_WEAPONS, CanPromote = false},
